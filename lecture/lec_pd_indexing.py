...
# In‑Class Exercise 1
# Please selectthe values for the row indexes ['b', 'c', 'd', 'e'] for col1
...
# In‑Class Exercise 2
# Please selectthe values for the row indexes ['b', 'd', 'f', 'j'] for col1
# from the following dataframe
import pandas as pd
df = pd.DataFrame(
  {
...
# In‑Class Exercise 3
# Please selectthe values for the even‑indexed rows col2 from the following
# dataframe.
df = pd.DataFrame(
  {
    'col1': range(0, 20),
